...
public class AddSealWS {
	...
	public static void invokeAddSealWS2(ArrayList<String> sealNo, String TimeSlotID, String sealPos, String UpdatedBy) {

		for (int i=0; i<sealNo.size(); i++) {
			...
			propertyInfoSN.setName("sealNo");
			// Set Value
			propertyInfoSN.setValue(sealNo.get(i));
			// Set dataType
			propertyInfoSN.setType(String.class);
			// Add the property to request object
			request.addProperty(propertyInfoSN);
