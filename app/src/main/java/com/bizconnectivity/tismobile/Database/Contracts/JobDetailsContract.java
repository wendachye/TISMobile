...
public class JobDetailsContract implements BaseColumns{
	...
	public static class JobDetails implements BaseColumns {
		...
		public static final String COLUMN_SDS_FILE_URL = "SDSFileURL";
		...
		public static final String COLUMN_PPE_STATUS = "";
		public static final String COLUMN_SDS_STATUS = "";
		public static final String COLUMN_SAFETY_CHECKS_STATUS = "";
		public static final String COLUMN_LOADING_ARM_STATUS = "";
		public static final String COLUMN_BATCH_CONTROLLER_STATUS = "";
		public static final String COLUMN_SCAN_SEAL_STATUS = "";
